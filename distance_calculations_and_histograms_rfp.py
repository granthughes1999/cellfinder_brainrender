...
def distance_calculations_histograms_rfp(brainrender_folder_path,mouse_id,estim_tip_coordinates,cellfinder_output_path):
    ...
    if not os.path.exists(histogram_folder_path):
        ...
        rfp_cells_path = cellfinder_output_path + 'points/tdTomato_points.npy'
        rfp_cells_path
        points = np.load(rfp_cells_path)
        ...
        plt.title(str(mouse_id) + ' rfp, Histogram of cell Euclidean distances from Estim tip')
        ...
        # Add labels
        plt.title(str(mouse_id) + ' rfp, Manhattan distances from Estim tip')
        ...
        plt.title(str(mouse_id) + ' rfp, Minkowski Distances from estim tip')
        ...
        plt.xlabel('rfp, Chebyshev Distance (um)')
        plt.ylabel('Cell count')
        plt.title(str(mouse_id) + ' rfp Chebyshev Distances from estim tip')
