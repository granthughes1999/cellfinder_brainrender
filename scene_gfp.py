...
def gfp_scene(brain_regions_to_evalutate,evaluate_brain_region_acronyms,evaluate_brain_regions,brain_regions_count_list,scene_gfp,loaded_cell_count_dict,extra_brain_region_names,scene_export_path,modified_gfp_cells_actor,overlapping_cells_actor,cells_actor, estim_tip_sphere_actor, estim_cylinder_actor,estim_propigation_sphere_actor):
  ...
  # # Add extra brain regions. specified in the extra_brain_region_acryonm list found in UpdateME.py
    ...
    if save_render == True:
        if not os.path.exists(scene_export_path):
            ...
            scene_gfp.export(scene_export_path)
    ...
    scene_gfp.add(modified_gfp_cells_actor,overlapping_cells_actor,cells_actor, estim_tip_sphere_actor, estim_cylinder_actor,estim_propigation_sphere_actor,opticalfiper_cylinder_actor ,opticalfiber_propigation_sphere_actor)
    scene_gfp.render()